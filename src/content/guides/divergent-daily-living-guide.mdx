...
faqs:
  ...
  - question: "What if it's not right for me?"
    answer: "Refunds are handled fairly, case by case. It's an instant-access digital guide, so there's no automatic refund — but if the file won't open, it's not as described, or you bought it by mistake, email us and we'll make it right."
---
